...
const mockApprovals = [
  { id: "1", title: "Phê duyệt đoàn Inbound Hàn Quốc", requester: "Trần Thu Hà", type: "Đoàn công tác", deadline: "Trong ngày", priority: "High", date: "10/04/2026" },
  { id: "2", title: "Duyệt lịch trình khảo sát KCN thung lũng Silicon", requester: "Nguyễn Văn A", type: "Lịch trình", deadline: "2 ngày tới", priority: "Medium", date: "11/04/2026" },
  { id: "3", title: "Yêu cầu hỗ trợ xe đưa đón đoàn Singapore", requester: "Lê Thị B", type: "Hậu cần", deadline: "3 ngày tới", priority: "Low", date: "12/04/2026" },
  { id: "4", title: "Phê duyệt biên bản ghi nhớ dự án ICT 2026", requester: "Phạm Minh Đức", type: "Biên bản", deadline: "Tuần sau", priority: "Medium", date: "15/04/2026" }
];
    ...
    <div className="space-y-8 duration-500 animate-in fade-in">
      ...
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex rounded-xl bg-slate-100 p-1 shrink-0">
          <button className="rounded-lg border border-slate-200/50 bg-white px-5 py-2 text-xs font-bold text-primary shadow-sm transition-all">Đang chờ (5)</button>
          <button className="rounded-lg px-5 py-2 text-xs font-bold text-slate-500 transition-all hover:text-slate-700">Đã duyệt</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        {mockApprovals.map((item) => (
          <div key={item.id} className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-primary/20 hover:shadow-md">
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-4">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => toast.error("Đã từ chối phê duyệt")} className="rounded-lg p-2 text-slate-400 transition-all hover:bg-rose-50 hover:text-rose-500 border border-transparent hover:border-rose-100">
                  <XCircle size={18} />
                </button>
                <button
        ...
        <div className="flex flex-col items-center justify-center space-y-3 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50/30 p-6 text-center opacity-70">
