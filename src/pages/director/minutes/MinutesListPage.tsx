      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex flex-1 items-center gap-3">
            ...
            <button onClick={handleFilter} className="rounded-lg border border-slate-200 bg-slate-50 p-2.5 text-slate-400 transition-all hover:bg-white hover:text-primary">
              <Filter size={16} />
            </button>
          </div>
        </div>
