...
export default function DashboardPage() {
  ...
  const managerKpis = city
    ? [
        {
          title: "Đối tác trọng điểm",
          value: String(city.partners ?? 0),
          note: "từ city overview",
          icon: <Users size={20} />,
          color: "blue" as const,
        },
        {
          title: "Pipeline đang mở",
          value: String(city.pipelineProjects ?? 0),
          note: "dự án đang theo dõi",
          icon: <Briefcase size={20} />,
          color: "emerald" as const,
        },
        {
          title: "Đoàn công tác",
          value: String(city.activeDelegations ?? 0),
          note: "đang xử lý",
        ...
        },
        {
          ...
          value: String(city.upcomingEvents ?? 0),
          note: "đã lên lịch",
    ...
    : [
        {
          title: "Đoàn chờ duyệt",
          value: String(summary?.stats.delegations ?? 0),
          note: "delegations",
          icon: <ClipboardList size={20} />,
          color: "rose" as const,
        },
        {
          title: "Việc cần quyết",
          value: String(summary?.stats.tasks ?? 0),
          note: "tasks",
        ...
        {
          title: "Lịch họp tuần",
          value: String(summary?.stats.events ?? 0),
          note: "events",
          icon: <Calendar size={20} />,
          color: "amber" as const,
        },
        {
          ...
          value: String(summary?.overdueTasks.length ?? 0),
          note: "overdue",
        ...
        {isAdmin ? (
          ...
          <>
            {managerKpis.map((item) => (
              <StatCard key={item.title} isLoading={summaryQuery.isLoading} title={item.title} value={item.value} note={item.note} icon={item.icon} color={item.color} />
            ))}
          </>
        ) : (
          <>
