...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 duration-700 animate-in fade-in">
      ...
      {isDirector && (
        <section className="grid gap-4 rounded-2xl border border-brand-dark/10 bg-white p-5 shadow-sm lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-4">
            <div className="flex items-center gap-3 border-b border-brand-dark/5 pb-4">
              <div className="rounded-xl bg-brand-dark p-3 text-white shadow-sm">
                <Target size={18} />
              </div>
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.24em] text-primary">Director Control Center</p>
                <h2 className="text-lg font-black uppercase tracking-tight text-brand-dark">Tín hiệu chiến lược hiện tại</h2>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-brand-dark/5 bg-brand-dark/[0.02] p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <button onClick={() => navigate("/city-overview")} className="rounded-xl bg-brand-dark px-4 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-white transition hover:bg-slate-800">
                Mở tổng quan thành phố
              </button>
              <button onClick={() => navigate("/reports/city")} className="rounded-xl border border-brand-dark/10 bg-white px-4 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-brand-text-dark/80 transition hover:bg-brand-dark/[0.02]">
