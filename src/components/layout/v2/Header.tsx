          ...
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-3 rounded-lg border border-transparent p-1.5 transition-all hover:border-slate-100 hover:bg-slate-50">
              <div className="hidden text-right sm:block">
                <p className="text-xs font-black uppercase tracking-tight text-slate-900">{user?.fullName || "Người dùng"}</p>
                <p className="mt-0.5 text-[9px] font-black uppercase tracking-widest text-slate-400">{user?.role || "Khách"}</p>
              </div>
