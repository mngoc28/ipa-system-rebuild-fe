    ...
    <div className="space-y-3">
      {isLoading ? (
        <div className="flex h-64 items-center justify-center">
          <LoadingSpinner label="Đang tải dữ liệu hồ sơ..." size={32} />
        </div>
      ) : (
        <>
          {projects.map((project) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-primary/10 bg-white font-bold text-primary/40 shadow-sm transition-all group-hover:border-primary/30 group-hover:bg-primary/5 group-hover:text-primary">
                  <CircleDot size={18} />
                </div>
